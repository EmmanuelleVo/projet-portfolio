    ...
    <main class="layout contact">
        <div class="big-screen">
            ...
            <div class="contact__container">
                ...
                <h2 class="page__title"><?= __('Contactez-moi', 'noair') ?></h2>
                <p class="contact__content"><?= __('Contactez-noi via ce formulaire ou mon adresse mail.', 'noair') ?></p>
                ...
                <form class="contact__form form" method="post" action="<?= get_home_url() ?>/wp-admin/admin-post.php">
                    ...
                    <div class="form__field">
                        ...
                        <input type="email" class="form__input" name="email" id="email"
                               placeholder="emmanuellevo@gmail.com"
                               value="<?= pf_get_contact_form_field_value('email') ?>">
                        <?= pf_get_contact_form_field_error('email') ?>
                    </div>
                    <div class="form__field">
                        <label for="phone" class="form__label"><?= __('Numéro de téléphone', 'pf') ?> <span
                                    class="optional">(<?= __('optionnel', 'pf') ?>)</span></label>
                    ...
                    <div class="form__field">
                        ...
                        <textarea name="message" id="message" cols="30"
                                  placeholder="<?= __('Écrivez votre message.', 'pf') ?>"
